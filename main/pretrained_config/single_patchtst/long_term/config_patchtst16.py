...
config = {
  ...
  'dataset_setting':{
    "main_csv": "/Users/hwangsoyeon/project2/dataset/complete_dataset.csv",
    "time_axis": "일시",
    "target": "PM-2.5"
  },
  "window_params":{
  ...
  "save_files":{
      "csv": "csv/single_patchtst/patchtst16.csv",
      "day": "figs/single_patchtst/everyday/graph16.jpg",
      "peak": "figs/single_patchtst/peakday/config16/"
  }
}